 ...
 *
 * Tests threshold validation, state transitions, and business rules.
...
class AlertServiceThresholdTest {
    ...
    void triggeringOneAlert_doesNotAffectOtherAlerts() {
        ...
        assertNotEquals("TRIGGERED", fetched2.getStatus());
    }
}